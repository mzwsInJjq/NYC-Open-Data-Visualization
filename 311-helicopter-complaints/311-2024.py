...
# Read 'Created Date' as datetime
helicopter_complaints['Created Date'] = pd.to_datetime(helicopter_complaints['Created Date'])

# Filter by 'Created Date' >= '2024-01-01' and 'Created Date' <= '2024-12-31'
helicopter_complaints = helicopter_complaints[(helicopter_complaints['Created Date'] >= '2024-01-01') & (helicopter_complaints['Created Date'] <= '2024-12-31')]
...
plt.savefig('nyc-311-helicopter-2024.pdf', format='pdf', bbox_inches='tight')
plt.savefig('nyc-311-helicopter-2024.png', format='png', bbox_inches='tight', dpi=600)